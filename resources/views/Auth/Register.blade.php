...
<div class="row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input class="form-control" id="identificacion" type="number" name="identificacion"><span class="help-block">Ingresa tus Nombres</span>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-md-3 col-form-label" for="identificacion">Apellidos</label>
        <div class="col-md-9">
            <input class="form-control" id="identificacion" type="number" name="identificacion"><span class="help-block">Ingresa tus Apellidos</span>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="col-md-9">
    <input class="form-control" id="password-input" type="password" name="password-input" placeholder="Password" autocomplete="new-password"><span class="help-block">Ingresa una password</span>
    </div>
    </div>
    <div class="form-group row">
